    ...
    protected function subjectLabel(): Attribute
    {
        return Attribute::get(function (): string {
            ...
            $subjectName = match ($this->subject_type) {
                ...
                CategoriaArticulo::class => 'Categoría de producto',
                UnidadMedida::class => 'Unidad de medida',
                Articulo::class => 'Producto',
                PresentacionArticulo::class => 'Presentación de producto',
                Lote::class => 'Lote',
                MovimientoInventario::class => 'Movimiento de inventario',
                DetalleMovimientoInventario::class => 'Detalle de inventario',
                Recepcion::class => 'Recepción',
                DetalleRecepcion::class => 'Detalle de recepción',
                Role::class => 'Rol',
