...
class Index extends Component
{
    ...
    public function propertyLabel(string $property): string
    {
        return match ($property) {
            ...
            'estado_articulo' => 'Estado del artículo',
    ...
    private function formatRouteValue(string $route): string
    {
        return match ($route) {
            ...
            'panel.categorias-articulos.index' => 'Gestión de categorías de artículos',
            'panel.unidades-medida.index' => 'Gestión de unidades de medida',
            'panel.articulos.index' => 'Gestión de artículos',
            'panel.presentaciones-articulos.index' => 'Gestión de presentaciones de artículos',
