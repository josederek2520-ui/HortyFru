...
enum PermissionName: string
{
    ...
    case PurchasesView = 'compras.ver';
    case PurchasesCreate = 'compras.crear';
    case PurchasesUpdate = 'compras.editar';
    case PurchasesRegister = 'compras.registrar';
    case PurchasesCancel = 'compras.cancelar';
    case LotsView = 'lotes.ver';
    case LotsUpdate = 'lotes.editar';
    case LotsChangeStatus = 'lotes.cambiar_estado';
    case InventoryMovementsView = 'movimientos_inventario.ver';
    case ReceptionsView = 'recepciones.ver';
    case ReceptionsCreate = 'recepciones.crear';
    case ReceptionsUpdate = 'recepciones.editar';
    case ReceptionsConfirm = 'recepciones.confirmar';
    case ReceptionsCancel = 'recepciones.cancelar';
    ...
    public function label(): string
    {
        return match ($this) {
            ...
            self::ArticleCategoriesView => 'Ver categorías de productos',
            self::ArticleCategoriesCreate => 'Crear categorías de productos',
            self::ArticleCategoriesUpdate => 'Editar categorías de productos',
            self::ArticleCategoriesChangeStatus => 'Activar o desactivar categorías de productos',
            ...
            self::ArticlesView => 'Ver productos',
            self::ArticlesCreate => 'Crear productos',
            self::ArticlesUpdate => 'Editar productos',
            self::ArticlesChangeStatus => 'Activar o desactivar productos',
            self::ArticlePresentationsView => 'Ver presentaciones de productos',
            self::ArticlePresentationsCreate => 'Crear presentaciones de productos',
            self::ArticlePresentationsUpdate => 'Editar presentaciones de productos',
            self::ArticlePresentationsChangeStatus => 'Activar o desactivar presentaciones de productos',
            ...
            self::PurchasesView => 'Ver compras',
            self::PurchasesCreate => 'Crear compras',
            self::PurchasesUpdate => 'Editar compras en borrador',
            self::PurchasesRegister => 'Registrar compras terminadas',
            self::PurchasesCancel => 'Cancelar compras',
            self::LotsView => 'Ver lotes',
            self::LotsUpdate => 'Editar información de lotes',
            self::LotsChangeStatus => 'Bloquear o habilitar lotes',
            self::InventoryMovementsView => 'Ver movimientos de inventario',
            self::ReceptionsView => 'Ver recepciones',
            self::ReceptionsCreate => 'Crear recepciones',
            self::ReceptionsUpdate => 'Editar recepciones en borrador',
            self::ReceptionsConfirm => 'Confirmar recepciones e ingresar inventario',
            self::ReceptionsCancel => 'Cancelar recepciones en borrador',
    ...
    public function moduleLabel(): string
    {
        return match ($this->module()) {
            ...
            'articulos' => 'Productos',
            'presentaciones_articulos' => 'Presentaciones de productos',
            'pedidos' => 'Pedidos',
            'compras' => 'Compras',
            'lotes' => 'Lotes',
