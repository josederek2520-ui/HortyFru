        ...
        return [
            ...
            [
                ...
                'items' => [
                    ...
                    ['icon' => 'article-categories', 'name' => 'Categorías de artículos', 'path' => '/panel/categorias-articulos', 'permission' => 'categorias_articulos.ver'],
                    ['icon' => 'measurement-units', 'name' => 'Unidades de medida', 'path' => '/panel/unidades-medida', 'permission' => 'unidades_medida.ver'],
                    ['icon' => 'articles', 'name' => 'Artículos', 'path' => '/panel/articulos', 'permission' => 'articulos.ver'],
                    ['icon' => 'article-presentations', 'name' => 'Presentaciones de artículos', 'path' => '/panel/presentaciones-articulos', 'permission' => 'presentaciones_articulos.ver'],
                ],
            ],
            [
                'title' => 'Comercial',
