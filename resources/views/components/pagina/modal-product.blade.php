				...
				<div class="flex flex-wrap">
					<div class="md:w-1/2">
						...
						<div class="product productModal" id="productModal">
							<div class="zoom" onmousemove="zoom(event)" style="background-image: url({{ asset('pagina_web/images/products/product-single-img-1.jpg') }})">
								<!-- img -->
								<!-- img -->
								<img src="{{ asset('pagina_web/images/products/product-single-img-1.jpg') }}" alt="" />
							</div>
							<div>
								<div class="zoom" onmousemove="zoom(event)" style="background-image: url({{ asset('pagina_web/images/products/product-single-img-2.jpg') }})">
									<!-- img -->
									<img src="{{ asset('pagina_web/images/products/product-single-img-2.jpg') }}" alt="" />
								</div>
							</div>
							<div>
								<div class="zoom" onmousemove="zoom(event)" style="background-image: url({{ asset('pagina_web/images/products/product-single-img-3.jpg') }})">
									<!-- img -->
									<img src="{{ asset('pagina_web/images/products/product-single-img-3.jpg') }}" alt="" />
								</div>
							</div>
							<div>
								<div class="zoom" onmousemove="zoom(event)" style="background-image: url({{ asset('pagina_web/images/products/product-single-img-4.jpg') }})">
									<!-- img -->
									<img src="{{ asset('pagina_web/images/products/product-single-img-4.jpg') }}" alt="" />
								</div>
							</div>
						</div>
						<!-- product tools -->
