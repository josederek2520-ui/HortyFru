@extends('layouts.panel.fullscreen-layout', ['title' => 'Iniciar sesión'])
        ...
        <div class="relative flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
                    ...
                    <div>
                        <div class="mb-5 sm:mb-8">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Ingresa tu correo electrónico y contraseña para acceder al sistema.
                            </p>
                        </div>
                        <div>
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="email" name="email" value="{{ old('email') }}"
                                            placeholder="correo@empresa.com" required autofocus autocomplete="username"
                                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                                        @error('email')
                                            <p class="text-error-500 mt-1.5 text-sm">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <!-- Contraseña -->
                                    <div>
                                        ...
                                        <div x-data="{ showPassword: false }" class="relative">
                                            ...
                                            <button type="button" @click="showPassword = !showPassword"
                                                ...
                                                class="absolute top-1/2 right-2 z-30 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-lg text-gray-500 transition hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800">
            ...
            <div class="bg-brand-950 relative hidden h-full w-full items-center lg:grid lg:w-1/2 dark:bg-white/5">
                <div class="z-1 flex items-center justify-center">
                    ...
                    <x-panel.common.common-grid-shape/>
                    <div class="flex max-w-sm flex-col items-center px-8">
                        <a href="/" class="mb-5 inline-flex items-center gap-4" aria-label="Ir al inicio de HortyFru">
                            <span class="flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500 text-white shadow-theme-md">
                                <svg class="h-7 w-7" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M12 20V9m0 4c-3.8 0-6.5-2.3-7-6.5 4.2-.4 7 1.5 7 5.3m0 1.2c3.8 0 6.5-2.3 7-6.5-4.2-.4-7 1.5-7 5.3" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" /></svg>
                            </span>
                            <span class="text-3xl font-semibold tracking-tight text-white">HortyFru</span>
                        </a>
                        <p class="text-center text-sm leading-6 text-gray-400 dark:text-white/60">
                            Gestión de inventario, pedidos y operaciones en un solo lugar.
                        </p>
                    </div>
                </div>
            </div>
