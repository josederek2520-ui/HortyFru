...
@section('content')
    {{-- Page Breadcrumb --}}
    <x-panel.common.page-breadcrumb pageTitle="Images" />

    <div class="space-y-5 sm:space-y-6">

        <x-panel.common.component-card title="Responsive Image">
            <div class="relative">
        ...
        <x-panel.common.component-card title="Image in 2 Grid">
        ...
        <x-panel.common.component-card title="Image in 3 Grid">
