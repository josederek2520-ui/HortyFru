...
@section('content')
    <x-panel.common.page-breadcrumb pageTitle="Badges" />
    ...
    <div class="space-y-5 sm:space-y-6">
        <x-panel.common.component-card title="With Light Background">
            <div class="flex flex-wrap gap-4 sm:items-center sm:justify-center">
                @foreach ($colors as $color)
                    <x-panel.ui.badge :color="$color">
                        {{ $color }}
                    </x-panel.ui.badge>
                @endforeach
            </div>
        ...
        <x-panel.common.component-card title="With Solid Background">
            <div class="flex flex-wrap gap-4 sm:items-center sm:justify-center">
                @foreach ($colors as $color)
                    <x-panel.ui.badge :color="$color" variant="solid">
                        {{ $color }}
                    </x-panel.ui.badge>
                @endforeach
            </div>
        ...
        <x-panel.common.component-card title="Light Background with Left Icon">
            <div class="flex flex-wrap gap-4 sm:items-center sm:justify-center">
                @foreach ($colors as $color)
                    <x-panel.ui.badge :color="$color" :startIcon="$plusIcon">
                        {{ $color }}
                    </x-panel.ui.badge>
                @endforeach
            </div>
        ...
        <x-panel.common.component-card title="Solid Background with Left Icon">
            <div class="flex flex-wrap gap-4 sm:items-center sm:justify-center">
                @foreach ($colors as $color)
                    <x-panel.ui.badge :color="$color" variant="solid" :startIcon="$plusIcon">
                        {{ $color }}
                    </x-panel.ui.badge>
                @endforeach
            </div>
        ...
        <x-panel.common.component-card title="Light Background with Right Icon">
            <div class="flex flex-wrap gap-4 sm:items-center sm:justify-center">
                @foreach ($colors as $color)
                    <x-panel.ui.badge :color="$color" :endIcon="$plusIcon">
                        {{ $color }}
                    </x-panel.ui.badge>
                @endforeach
            </div>
        ...
        <x-panel.common.component-card title="Solid Background with Right Icon">
            <div class="flex flex-wrap gap-4 sm:items-center sm:justify-center">
                @foreach ($colors as $color)
                    <x-panel.ui.badge :color="$color" variant="solid" :endIcon="$plusIcon">
                        {{ $color }}
                    </x-panel.ui.badge>
                @endforeach
            </div>
