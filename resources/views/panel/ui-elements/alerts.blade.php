...
@section('content')
    <x-panel.common.page-breadcrumb pageTitle="Alerts" />

    <div class="space-y-5 sm:space-y-6">
        {{-- Success Alert --}}
        <x-panel.common.component-card title="Success Alert">
            <div class="space-y-4">
                <x-panel.ui.alert
                    variant="success"
        ...
        {{-- Warning Alert --}}
        <x-panel.common.component-card title="Warning Alert">
            <div class="space-y-4">
                <x-panel.ui.alert
                    variant="warning"
        ...
        {{-- Error Alert --}}
        <x-panel.common.component-card title="Error Alert">
            <div class="space-y-4">
                <x-panel.ui.alert
                    variant="error"
                    title="Error Message"
        ...
        {{-- Info Alert --}}
        <x-panel.common.component-card title="Info Alert">
            <div class="space-y-4">
                <x-panel.ui.alert
                    variant="info"
                    title="Info Message"
        ...
        {{-- Additional Examples --}}
        <x-panel.common.component-card title="Alert Variations">
            <div class="space-y-4">
                {{-- With Slot Content --}}
                <x-panel.ui.alert variant="success" title="Custom Content Alert">
        ...
        {{-- Interactive Demo --}}
        <x-panel.common.component-card title="Real-World Examples">
            <div class="space-y-4">
                {{-- Payment Success --}}
                <x-panel.ui.alert variant="success" title="Payment Successful">
                ...
                {{-- Validation Error --}}
                <x-panel.ui.alert variant="error" title="Form Validation Failed">
