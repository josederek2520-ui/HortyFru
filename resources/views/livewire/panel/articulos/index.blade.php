<div class="flex flex-col gap-6">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div class="flex flex-col gap-1">
            ...
            <h1 class="text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Artículos</h1>
    ...
    <section aria-labelledby="articles-table-heading" class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-theme-xs dark:border-gray-800 dark:bg-white/[0.03]">
        <h2 id="articles-table-heading" class="sr-only">Listado de artículos</h2>
        ...
        <div class="grid grid-cols-1 gap-4 border-b border-gray-200 p-4 dark:border-gray-800 xl:grid-cols-[auto_minmax(18rem,32rem)_auto] xl:items-center xl:justify-between">
            <div class="grid grid-cols-3 rounded-xl bg-gray-100 p-1 dark:bg-gray-900" role="group" aria-label="Filtrar artículos por estado">
            ...
            <label class="relative block w-full xl:justify-self-center">
                ...
                <input type="search" wire:model.live.debounce.350ms="search" placeholder="Buscar artículo, categoría o unidad..." class="h-11 w-full rounded-xl border border-gray-300 bg-transparent py-2.5 pl-11 pr-4 text-sm text-gray-800 outline-none transition placeholder:text-gray-400 focus:border-brand-400 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:text-white dark:placeholder:text-gray-500 dark:focus:border-brand-500" />
            </label>
        ...
        @if ($this->articles->isEmpty())
            <div class="flex flex-col items-center gap-3 px-6 py-16 text-center">
                ...
                <div><h3 class="font-semibold text-gray-800 dark:text-white/90">No encontramos artículos</h3><p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Prueba con otra búsqueda o registra el primer artículo.</p></div>
            ...
            <div class="hidden overflow-x-auto md:block">
                <table class="w-full text-left">
                    <thead class="border-b border-gray-200 bg-gray-50 dark:border-gray-800 dark:bg-gray-900/50">
                        <tr class="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400"><th class="px-5 py-3.5">Artículo</th><th class="px-5 py-3.5">Categoría</th><th class="px-5 py-3.5">Unidad</th><th class="px-5 py-3.5">Estado</th><th class="px-5 py-3.5 text-right">Acciones</th></tr>
                    </thead>
                    ...
                    <div x-on:dragover.prevent x-on:drop.prevent="$refs.articleImage.files = $event.dataTransfer.files; $refs.articleImage.dispatchEvent(new Event('change', { bubbles: true }))" class="grid gap-4 rounded-2xl border border-dashed p-4 transition {{ $errors->has('form.imagen_articulo') ? 'border-error-400 bg-error-50/40 dark:bg-error-500/5' : 'border-gray-300 bg-gray-50/70 hover:border-brand-400 dark:border-gray-700 dark:bg-white/[0.02]' }} sm:grid-cols-[7rem_minmax(0,1fr)] sm:items-center">
                        <div class="relative mx-auto flex h-28 w-28 items-center justify-center overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800 sm:mx-0">
                            ...
                            @elseif ($this->currentImageUrl)
                                <img src="{{ $this->currentImageUrl }}" alt="Imagen actual del artículo" class="h-full w-full object-cover" />
                            @else
