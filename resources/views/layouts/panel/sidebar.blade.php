        ...
        <a href="{{ route('panel.inicio') }}" class="flex items-center gap-3" aria-label="Ir al panel de HortyFru">
            <span class="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-success-500 text-white shadow-theme-xs">
                <svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                    ...
                    <path d="M4.5 20c2.2-5.1 5.8-8.4 10.8-10.2" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" />
                </svg>
            </span>
            <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen" class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                Horty<span class="text-success-500">Fru</span>
            </span>
        </a>
    </div>
